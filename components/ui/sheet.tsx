  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover p-6 text-popover-foreground ring-1 ring-foreground/10 outline-none transition-transform duration-200 data-open:animate-in data-closed:animate-out",
          side === "right" &&
